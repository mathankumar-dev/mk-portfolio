    ...
    <section className="py-16 sleek-border-t">
      <div className="max-w-4xl mx-auto px-6 space-y-8">
        <div>
          ...
          <p className="text-xs text-neutral-500 mt-0.5">Engineering roles and production development track record.</p>
        </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                <div>
                  ...
                  <div className="text-xs font-mono text-neutral-400">
                    <span className="text-neutral-300">{item.company}</span> • <span>{item.location}</span>
                  </div>
                </div>
