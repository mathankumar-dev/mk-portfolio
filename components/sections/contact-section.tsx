        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-3 text-sm">
            ...
            <a
              ...
              className="px-4 py-2 rounded-md bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-neutral-800 dark:text-neutral-300 hover:text-black dark:hover:text-white hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors inline-flex items-center gap-1.5 font-mono text-xs"
            >
