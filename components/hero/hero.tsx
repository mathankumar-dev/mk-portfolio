        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 sm:gap-8 md:gap-12">
          ...
          <div className="flex-1 space-y-5 sm:space-y-6">
            ...
            <h1 className="space-y-1.5 tracking-tight">
              <span className="block text-2xl sm:text-4xl md:text-[2.65rem] font-bold text-white leading-tight">
                Flutter &amp; Full-Stack Developer
              </span>
              <span className="block text-lg sm:text-2xl md:text-[1.65rem] font-medium text-neutral-300 leading-snug">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-1 text-sm">
              ...
              <Link
                href="/about"
                className="px-3 sm:px-4 py-2 text-neutral-300 hover:text-white transition-colors text-xs sm:text-sm"
              >
                About &amp; Philosophy →
              </Link>
            </div>
          ...
          {/* Prominent Portrait Card - Desktop Right, Mobile Integrated */}
          <div className="hidden md:block shrink-0 relative group">
            ...
            <div className="relative w-52 h-52 lg:w-56 lg:h-56 rounded-2xl overflow-hidden border border-neutral-800 bg-neutral-900/80 shadow-2xl">
              <Image
                src="/mk-portfolio/images/profile.jpg"
                alt="Mathankumar V"
                fill
